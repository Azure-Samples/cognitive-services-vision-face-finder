...
Images in these screenshots are from [Labeled Faces in the Wild](http://vis-www.cs.umass.edu/lfw/). For one list of datasets containing images of people, see [CVonline: Image Databases, People](http://homepages.inf.ed.ac.uk/rbf/CVonline/Imagedbase.htm#human).
